...
button:focus-visible { box-shadow: 0 0 0 3px rgba(26, 54, 93, 0.3); }
input:focus-visible { box-shadow: 0 0 0 3px rgba(251, 146, 60, 0.2); }
```
...
**Before:**
```jsx
<div className="bg-macon-navy-800 text-macon-navy-100">
