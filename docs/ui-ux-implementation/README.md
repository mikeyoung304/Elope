...
client/src/
├── components/
│   ├── navigation/AdminNav.tsx          # Phase 1
│   ├── ui/responsive-table.tsx          # Phase 1
│   ├── ui/metric-card.tsx               # Phase 2
│   ├── ui/theme-toggle.tsx              # Phase 3
│   ├── ui/pagination.tsx                # Phase 4
│   └── onboarding/OnboardingTour.tsx    # Phase 4
├── providers/
│   └── ThemeProvider.tsx                # Phase 3
├── styles/
│   ├── tokens.css                       # Phase 2
│   └── typography.css                   # Phase 2
└── lib/
    ├── toast.ts                         # Phase 1
...
├── src/pages/admin/PlatformAdminDashboard.tsx  # All phases
└── src/pages/tenant/TenantAdminDashboard.tsx   # All phases
```
