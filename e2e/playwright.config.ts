...
export default defineConfig({
  ...
  webServer: {
    command: 'ADAPTERS_PRESET=real VITE_API_URL=http://localhost:3001 VITE_APP_MODE=mock VITE_E2E=1 VITE_TENANT_API_KEY=pk_live_mais-e2e_0000000000000000 npm run dev:e2e',
    cwd: '..',
